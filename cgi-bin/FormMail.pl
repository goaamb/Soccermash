#!/usr/bin/perl
##############################################################################
# FormMail                        Version 1.92 SFH                               #
# Copyright 1995-2002 Matt Wright mattw@scriptarchive.com                    #
# Created 06/09/95                Last Modified 08/30/02                     #
...
#chomp(@referers=`cat /etc/virtual/domains`);
chomp(@referers=`cat /etc/virtual/domainowners | cut -d : -f 1`);
# @recipients defines the e-mail addresses or domain names that e-mail can   #
# be sent to.  This must be filled in correctly to prevent SPAM and allow    #
# valid addresses to receive e-mail.  Read the documentation to find out how #
# this variable works!!!  It is EXTREMELY IMPORTANT.                         #

# chomp(@recipients=`find /home/sites -type l -maxdepth 1 -print | cut -c 13-`); #
# @recipients(); #
...
<html>
 ...
 <body bgcolor=#FF6600 text=#333333>
  <center>
   <table border=0 width=600 bgcolor=#00687F>
    <tr><th><font size=+2 color=#FFFFFF family=Arial,Helvetica,Sans-Serif>FormMail</font></th></tr>
   </table>
   <table border=0 width=600 bgcolor=#C0C0C0>
   ...
   <table border=0 width=600 bgcolor=#FF6600>
    <tr><th><tt><font size=+1 color=#FFFF00>SFH 2002 Modified<br>
        Version 1.92sfh - Released August 30, 2002<br>
        </font></tt></th></tr>
   </table>
