...
<title><?php echo $bb_language[0];?></title>
<meta name="viewport" id="viewport" content="width=device-width,height=device-height,initial-scale=1.0,user-scalable=no" />
<style type="text/css" media="screen">@import "css/cometchat.css";</style>
<script type="text/javascript" charset="utf-8" src="../cometchatjs.php?silent=true&callbackfn=bb"></script>
<script type="text/javascript" src="js/bb.php"></script>
...
<div id="whosonline">
	<div id="header" class="header">
		...
		<div class="roundedcenter"><?php echo $bb_language[1];?></div>
		<div class="roundedright"><?php echo $bb_language[2];?></div>
