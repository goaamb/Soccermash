...
$('#msgThread li').click(function(){
									//alert('entra');
								  var viewMsg = $(this).attr('id');
									//alert(viewMsg);
									//var z = '#' + viewMsg + ' .msgholder';
									//alert(z);
									$('#' + viewMsg + ' .msgholder').slideToggle('fast');		
...
$("#foundationDate").datepicker({changeMonth: true, changeYear: true}).datepicker("option", "yearRange", '1900:+nn');//birthday
