<?php
	...
	global $_IDIOMA;
		...
		$totalPaginas = ceil($totalRegistros / $limiteRegistros);
			...
			if(!empty($variablesGet[7])){//storeSelectProfile
				$v7="<input type='hidden' name='sexito01' value='".$variablesGet[7]."' />";
			}else{
				$v7="";
			}
			if(!empty($variablesGet[8])){//storeSelectProfile
				$v8="<input type='hidden' name='sexito02' value='".$variablesGet[8]."' />";
			}else{
				$v8="";
			}
		...
		if (($paginaActual - 1) > 0)
		{				
				$paginado .="<form name='f2' id='f2' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual - 1)."' />$v5 $v6 $v7</form>";
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"f2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';

		}
		if (($paginaActual + 1) <= $totalPaginas)
		{
			
			$paginado .="<form name='e3' id='e3' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual + 1)."' />$v5 $v6 $v7</form>";
	...
	global $_IDIOMA;
		...
		{				
				...
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"fc2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"ec3\").submit();\'>'.$_IDIOMA->traducir("more results").'</a></span>';
			//"<a target='iframeSearch' method='POST' href='gestion/modulos/home/findAll.php?pageNum=" . ($paginaActual + 1) . $v0.$v1.$v2.$v3.$v4.$v5.$v6 . "'>&gt;</a>";
		}
	...
	global $_IDIOMA;
		...
		{				
				...
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"ff2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"ef3\").submit();\'>'.$_IDIOMA->traducir("more results").'</a></span>';
			//"<a target='iframeSearch' method='POST' href='gestion/modulos/home/findAll.php?pageNum=" . ($paginaActual + 1) . $v0.$v1.$v2.$v3.$v4.$v5.$v6 . "'>&gt;</a>";
		}
	...
	global $_IDIOMA;
		...
		$totalPaginas = ceil($totalRegistros / $limiteRegistros);
			...
			if(!empty($variablesGet[21])){//position10
				$v21="<input type='hidden' name='sexito01' value='".$variablesGet[21]."' />";
			}else{
				$v21="";
			}
			if(!empty($variablesGet[22])){//position10
				$v22="<input type='hidden' name='sexito02' value='".$variablesGet[22]."' />";
			}else{
				$v22="";
			}
			if(!empty($variablesGet[23])){//position10
				$v23="<input type='hidden' name='eupassp' value='".$variablesGet[23]."' />";
			}else{
				$v23="";
			}
			if(!empty($variablesGet[24])){//position10
				$v24="<input type='hidden' name='otherPassP' value='".$variablesGet[24]."' />";
			}else{
				$v24="";
			}
		...
		if (($paginaActual - 1) > 0)
		{				
				$paginado .="<form name='f2' id='f2' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual - 1)."' />$v0 $v1 $v2 $v3 $v4 $v5 $v6 $v7 $v8 $v9 $v10 $v11 $v12 $v13 $v14 $v15 $v16 $v17 $v18 $v19 $v20 $v21 $v22</form>";
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"f2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			$paginado .="<form name='e3' id='e3' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual + 1)."' />$v0 $v1 $v2 $v3 $v4 $v5 $v6 $v7 $v8 $v9 $v10 $v11 $v12 $v13 $v14 $v15 $v16 $v17 $v18 $v19 $v20 $v21 $v22</form>";
			$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"e3\").submit();\'>'.$_IDIOMA->traducir("more results").'</a></span>';
			//"<a target='iframeSearch' method='POST' href='gestion/modulos/home/findAll.php?pageNum=" . ($paginaActual + 1) . $v0.$v1.$v2.$v3.$v4.$v5.$v6 . "'>&gt;</a>";
		}
	...
	{global $_IDIOMA;
		...
		$totalPaginas = ceil($totalRegistros / $limiteRegistros);
			...
			if(!empty($variablesGet[13])){//position10
				$v13="<input type='hidden' name='sexito01' value='".$variablesGet[13]."' />";
			}else{
				$v13="";
			}
			if(!empty($variablesGet[12])){//position10
				$v12="<input type='hidden' name='sexito02' value='".$variablesGet[12]."' />";
			}else{
				$v12="";
			}
		...
		if (($paginaActual - 1) > 0)
		{				
				$paginado .="<form name='f2' id='f2' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual - 1)."' />$v0 $v1 $v2 $v3 $v4 $v5 $v6 $v7 $v8 $v9 $v10 $v11 $v12 $v13</form>";
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"f2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			$paginado .="<form name='e3' id='e3' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual + 1)."' />$v0 $v1 $v2 $v3 $v4 $v5 $v6 $v7 $v8 $v9 $v10 $v11 $v12 $v13</form>";
			$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"e3\").submit();\'>'.$_IDIOMA->traducir("more results").'</a></span>';
			//"<a target='iframeSearch' method='POST' href='gestion/modulos/home/findAll.php?pageNum=" . ($paginaActual + 1) . $v0.$v1.$v2.$v3.$v4.$v5.$v6 . "'>&gt;</a>";
		}
	...
	global $_IDIOMA;
		...
		$totalPaginas = ceil($totalRegistros / $limiteRegistros);
			...
			if(!empty($variablesGet[7])){//position10
				$v7="<input type='hidden' name='sexito01' value='".$variablesGet[7]."' />";
			}else{
				$v7="";
			}
			if(!empty($variablesGet[8])){//position10
				$v8="<input type='hidden' name='sexito02' value='".$variablesGet[8]."' />";
			}else{
				$v8="";
			}
		...
		if (($paginaActual - 1) > 0)
		{				
				$paginado .="<form name='f2' id='f2' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual - 1)."' />$v0 $v1 $v2 $v3 $v4 $v5 $v6 $v7 $v8</form>";
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"f2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			$paginado .="<form name='e3' id='e3' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual + 1)."' />$v0 $v1 $v2 $v3 $v4 $v5 $v6 $v7 $v8</form>";
			$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"e3\").submit();\'>'.$_IDIOMA->traducir("more results").'</a></span>';
			//"<a target='iframeSearch' method='POST' href='gestion/modulos/home/findAll.php?pageNum=" . ($paginaActual + 1) . $v0.$v1.$v2.$v3.$v4.$v5.$v6 . "'>&gt;</a>";
		}
	...
	{global $_IDIOMA;
		...
		if (($paginaActual - 1) > 0)
		{				
				$paginado .="<form name='f2' id='f2' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual - 1)."' />$v3 $v4 $v5 $v6 $v7 $v8</form>";
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"f2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			$paginado .="<form name='e3' id='e3' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual + 1)."' />$v3 $v4 $v5 $v6 $v7 $v8</form>";
			$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"e3\").submit();\'>'.$_IDIOMA->traducir("more results").'</a></span>';
			//"<a target='iframeSearch' method='POST' href='gestion/modulos/home/findAll.php?pageNum=" . ($paginaActual + 1) . $v0.$v1.$v2.$v3.$v4.$v5.$v6 . "'>&gt;</a>";
		}
	...
	{global $_IDIOMA;
		...
		if (($paginaActual - 1) > 0)
		{				
				$paginado .="<form name='f2' id='f2' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual - 1)."' />$v0 $v1 $v3 $v4 $v5 $v6 $v7 $v8</form>";
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"f2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';
	...
	{global $_IDIOMA;
		...
		$totalPaginas = ceil($totalRegistros / $limiteRegistros);
			...
			if(!empty($variablesGet[7])){//storeSelectProfile
				$v7="<input type='hidden' name='orderVideo' value='".$variablesGet[7]."' />";
			}else{
				$v7="";
			}
		...
		if (($paginaActual - 1) > 0)
		{				
				$paginado .="<form name='f2' id='f2' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual - 1)."' />$v3 $v4 $v5 $v6 $v7</form>";
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"f2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			$paginado .="<form name='e3' id='e3' target='iframeSearch' method='POST' action='gestion/modulos/home/findAll.php'><input type='hidden' name='pageNum' value='".($paginaActual + 1)."' />$v3 $v4 $v5 $v6 $v7</form>";
			$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"e3\").submit();\'>'.$_IDIOMA->traducir("more results").'</a></span>';
			//"<a target='iframeSearch' method='POST' href='gestion/modulos/home/findAll.php?pageNum=" . ($paginaActual + 1) . $v0.$v1.$v2.$v3.$v4.$v5.$v6 . "'>&gt;</a>";
		}
	...
	{global $_IDIOMA;
		...
		{				
				...
				$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"fh2\").submit();\'>'.$_IDIOMA->traducir("previous results").'</a></span>';
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			$paginado .= '<span><a href=\'javascript:;\' onclick=\'document.getElementById(\"eh3\").submit();\'>'.$_IDIOMA->traducir("more results").'</a></span>';
			//"<a target='iframeSearch' method='POST' href='gestion/modulos/home/findAll.php?pageNum=" . ($paginaActual + 1) . $v0.$v1.$v2.$v3.$v4.$v5.$v6 . "'>&gt;</a>";
		}
	...
	global $_IDIOMA;
		...
		if (($paginaActual - 1) > 0)
		{
			...
			$paginado .= "<a onclick='loadVideosPaginate(iUp2);' href='javascript:;'>".$_IDIOMA->traducir('previous results')."</a>  ";
		}
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			$paginado .=  "<a onclick='loadVideosPaginate(iUp);' href='javascript:;'>".$_IDIOMA->traducir('more videos')."</a>";
	...
	global $_IDIOMA;
		...
		if (($paginaActual - 1) > 0)
		{
			...
			$paginado .= "<a onclick='loadPhotosPaginate(pUp2);' href='javascript:;'>".$_IDIOMA->traducir('previous results')."</a>  ";
		}
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			//$paginado .=  "<a onclick='videoProfile(\"".($i-1)."\");' href='javascript:;'>Siguiente</a>";
			$paginado .=  "<a onclick='loadPhotosPaginate(pUp);' href='javascript:;'>".$_IDIOMA->traducir('more photos')." </a>";
	...
	global $_IDIOMA;
		...
		if (($paginaActual - 1) > 0)
		{
			...
			$paginado .= "<a onclick='loadComment(aUpvNpN2);' href='javascript:;'>".$_IDIOMA->traducir('previous results')."</a>  ";
		}
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			//$paginado .=  "<a onclick='videoProfile(\"".($i-1)."\");' href='javascript:;'>Siguiente</a>";
			$paginado .=  "<a onclick='loadComment(aUpvNpN);' href='javascript:;'>".$_IDIOMA->traducir('more results')."</a>";
	...
	global $_IDIOMA;
		...
		if (($paginaActual - 1) > 0)
		{
			...
			$paginado .= "<a onclick='loadCommentPhoto(aUpvNpN2);' href='javascript:;'>".$_IDIOMA->traducir('previous results')."</a>  ";
		}
		...
		if (($paginaActual + 1) <= $totalPaginas)
		{
			...
			//$paginado .=  "<a onclick='videoProfile(\"".($i-1)."\");' href='javascript:;'>Siguiente</a>";
			$paginado .=  "<a onclick='loadCommentPhoto(aUpvNpN);' href='javascript:;'>".$_IDIOMA->traducir('more results')."</a>";
