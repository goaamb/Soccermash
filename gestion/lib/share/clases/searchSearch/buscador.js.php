...
/////////////////Busca///////////////////////////////	
	  ...
	  function busca(cual,rellena,tipo,user,hidden){
	 		...
	 		var valor=$("#"+cual).val();
			$("#"+rellena).html('');
			$("#"+rellena).load("gestion/lib/share/clases/searchSearch/busquedaSba.php",{valor:valor,tipo:tipo,user:user,hidden:hidden,rellena:rellena});
...
///////////////Buscare////////////////////////////////	  
	  function buscare(espacio,user,tipe,hidden){
			...
			$("#"+espacio).load("gestion/lib/share/clases/searchSearch/buscador.php",{tipe:tipe,user:user,hidden:hidden});
