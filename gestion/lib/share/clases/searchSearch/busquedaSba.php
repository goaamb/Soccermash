		...
		///////////////////Searching depending on $valor/////////////////////////
				...
				foreach ($registro as $persona){
					...
					if($tipo=="clubes"){	
						...
						echo "<div style='font-size:12px;' onclick='document.getElementById(\"$user\").value=\"".$persona->name."\"; hide_me(\"buscador1\"); '>".$persona->name." - ".$persona->federationName. $persona->otherFederation . $checkImg . "</div>";
