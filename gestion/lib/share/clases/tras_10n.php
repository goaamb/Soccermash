...
function ___($text, $domain = 'default') {
	return translate($text, $domain);
}
// .
/**
...
function load_panel_textdomain()
{
	$locale = SYSTEM_Language . '_' . strtoupper(SYSTEM_Language);
	$mofile = SERVER_HOME_Path . "/lenguaje/$locale.mo";
	load_textdomain('default', $mofile);
}

function load_web_textdomain($sLang = 'es')
{
