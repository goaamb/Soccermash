...
class JavaScriptCompressor
{
	...
	var $__startTime 			= 0;
	var $__sourceLength 		= 0;
	var $__sourceNewLength 	= 0;
	var $__totalSources 		= 0;
	var $__inlineFunction 	= '';
	var $__sources 			= array();
	var $__BC 					= NULL;
	 ...
	 */
	function getPacked($jsSource, $cc = true, $removeSpaces = true)
	{
		return $this->__commonInitMethods($jsSource, $removeSpaces, true);
	}
