 ...
 ////////////Check if the file is supported/////////////
		...
		if($fil[1]!='flv' && $fil[1]!='mp4' && $fil[1]!='f4v' && $fil[1]!='3gp' && $fil[1]!='mov' && $fil[1]!='FLV' && $fil[1]!='MP4' && $fil[1]!='F4V' && $fil[1]!='3GP' && $fil[1]!='MOV'){
			...
			<script type="text/javascript">
				...
				window.top.window.document.getElementById('saveVideoFile').innerHTML='Video format not supported';
...
require_once($_SERVER['DOCUMENT_ROOT'].$dir.'/gestion/modulos/video/youApi/youClass.php');
	...
	$rand=md5(addslashes($_POST['idUser'])).rand(10,300);
	...
	//////////////////Save file/////////////////////////
			...
			$youtube = new youtube(addslashes($_POST['youtube']));
	...
	//////////////////Get data//////////////////////////////////////////
			...
			$fields['tagsVideo']=addslashes($_POST['tagsVideo']);
			...
			if(addslashes($_POST['youtube'])){
				$fields['youtube']=addslashes($_POST['youtube']);
					...
					echo "
						<script type='text/javascript'>
							window.top.window.document.getElementById('saveVideoFile').innerHTML='Error saving data';
						</script>
					";
					...
					echo "
						<script type='text/javascript'>
							...
							window.top.window.document.getElementById('tagsVideo').value='';
