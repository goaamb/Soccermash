...
class VideoUserVote {
	...
	////////////////SELECT - SELECTS data////////////////
	function selectVideoUserVote($fields,$whereSel,$orderSel='id desc'){
				
		//$tableProfile=$this->selectTable($profileId);
		$tableProfile='ax_videoUserVote';
		
		$registros=$this->selVidUserVote($fields,$tableProfile,$whereSel,$orderSel);	
		return $registros;
...
///////////////SELECT the register/////////////////////////////
		...
		private function selVidUserVote($fields,$tableProfile,$whereSel,$orderSel){
...
////////////////ADD - Check where to insert the data////////////////
	function addVideoUserVote($fields){
				
		//$tableProfile=$this->selectTable($profileId);
		$tableProfile='ax_videoUserVote';
		if($this->addVidUserVote($tableProfile,$fields)){
			return true;
		}else{
			return false;
		}
...
///////////////Inserts the register into de tabl/////////////////////////////
		...
		function addVidUserVote($tableProfile,$fields){
...
////////////////UPDATE - Check where to insert the data////////////////
	function upVideoUserVote($fields,$whereUp){
				
		//$tableProfile=$this->selectTable($profileId);
		$tableProfile='ax_videoUserVote';
		
		if($this->upVidUserVote($tableProfile,$fields,$whereUp)){
			return true;
		}else{
			return false;
		}
...
///////////////UPDATE the register/////////////////////////////
	...
	private	function upVidUserVote($tableProfile,$fields,$whereUp){
...
////////////////Delete - Check where to insert the data////////////////
	function delVideoUserVote($whereDel){
			
			//$tableProfile=$this->selectTable($profileId);
			$tableProfile='ax_videoUserVote';
			
		if($this->delVidUserVote($tableProfile,$whereDel)){
			return true;
		}else{
			return false;
		}
...
///////////////Delete the register/////////////////////////////
		...
		function delVidUserVote($tableProfile,$whereDel){
