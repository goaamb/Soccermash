	...
	if($registros[0]!=''){
		...
		foreach($registros as $registro){
			...
			/////////check if its editable///////////
				...
				$delVid= '<div style="position:absolute; margin-left:160px;z-index:20;"><a title="delete" href="javascript:;" onclick="delVideo(iVpuF_ph'.$i.');"><img src="img/cancel.png"></a></div>';
				...
				<script type="text/javascript">
					...
					iFvpu_pOkuOk_n_ph_uN_pN<? echo $i; ?>.push('<? echo base64_encode($editProfile); ?>');
...
<div class="slide">
<div>'.$editName.'</div>'.$delVid.'
<div class="watermark" onclick="loadVideo(iFvpu_pOkuOk_n_ph_uN_pN'.$i.'); sumView(iVpu_pOk_uOk'.$i.'); ratesVote(rPuV'.$i.');"><img src="img/play.png"/></div>
<div class="screenshot"><img src="'.$imgVid.'" width="180" height="119" /></div>
</div>
