<?
				...
				//////filters for Agent profile/////
					$kindIdProfile="AND ( profileId ='24'";
									
					//ctry//
					if(!empty($_POST['countrySearch14'])){
						$_POST['countrySearch6']=$_POST['countrySearch14'];
					}
					
					if(!empty($_POST['countrySearch6'])){
						$countryName="AND countryName='".addslashes($_POST['countrySearch6'])."'";
					}else{
						$countryName='';
					}
			...
			if(!empty($_POST['countrySearch6'])){
				$v5="<input type='hidden' name='countrySearch6' value='".$_POST['countrySearch6']."' />";
			}else{
				$v5="";
			}
