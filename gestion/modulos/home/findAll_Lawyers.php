<?
				...
				//////filters for Agent profile/////
						$kindIdProfile="AND ( profileId ='17'";
					
										
					//ctry//
					if(!empty($_POST['countrySearch13'])){
						$_POST['countrySearch5']=$_POST['countrySearch13'];
					}
					
					if(!empty($_POST['countrySearch5'])){
						$countryName="AND countryName='".addslashes($_POST['countrySearch5'])."'";
					}else{
						$countryName='';
					}
			...
			if(!empty($_POST['countrySearch5'])){
				$v5="<input type='hidden' name='countrySearch5' value='".$_POST['countrySearch5']."' />";
			}else{
				$v5="";
			}
