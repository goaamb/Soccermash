<?
				...
				//////filters for Agent profile/////
						$kindIdProfile="AND ( profileId ='16'";
						
											
						//ctry//
						if(!empty($_POST['countrySearch12'])){
							$_POST['countrySearch4']=$_POST['countrySearch12'];
						}
						
						if(!empty($_POST['countrySearch4'])){
							$countryName="AND countryName='".addslashes($_POST['countrySearch4'])."'";
						}else{
							$countryName='';
						}
			...
			if(!empty($_POST['countrySearch4'])){
				$v5="<input type='hidden' name='countrySearch4' value='".$_POST['countrySearch4']."' />";
			}else{
				$v5="";
			}
