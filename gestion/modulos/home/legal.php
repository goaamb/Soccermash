...
<div id="tophelp">
<h2><? print $_IDIOMA->traducir("Legal Notice"); ?></h2>
</div>
 <span><a class="onright" id="closingHlp" title="Close help"><? print $_IDIOMA->traducir("Close"); ?></a></span>
  <div id="central">
      <div class="helpitem">
          ...
          <span class="title">
            <span></span>
              <? print $_IDIOMA->traducir("Legal Notice"); ?></span>
           <span id="visible" class="more"></span>
        </span>
        
        	<div class="holdcontent visible"><p><? print $_IDIOMA->traducir("This agreement has been written in Spanish on February 22d, 2011, in Spain. In case of any existing discrepancy between the original and some translated version of this site, the original in Spanish is the binding document.</p>
			 ...
			 <? print $_IDIOMA->traducir("<p>2. SERVICE ACCESS: Physical people over 12 years.</p>
        	  ...
        	  <? print $_IDIOMA->traducir("<p>3. PROFILE SECURITY</p>
        	  <p>You EXPRESSLY ACCEPT that the Service and the services of SOCCERMASH are offered exclusively for your personal use, and cannot be used for economic or commercial purposes without previous authorization of SOCCERMASH<br />
				...
				<? print $_IDIOMA->traducir("You will have to maintain the data updated at any moment that you provide.<br />
			  ...
			  <? print $_IDIOMA->traducir("<p>5. RESTRICTED USE</p><p>The access or the use of SOCCERMASH with an illegal or unauthorized purpose, with or without economical purpose, and, the following sections without these being the unique or the total ones, ARE ABSOLUTELY FORBIDDEN, and therefore, the consequences will be of exclusive responsibility:</p>
			 ...
			 <? print $_IDIOMA->traducir("<p>You will not solicit login information and you will not access an account belonging to other user.</p>
			  ...
			  <? print $_IDIOMA->traducir("<p>You will not offer any contest, giveaway or sweepstakes (&quot;promotion&quot;) without our prior written consent. In case we consent, you will take full responsibility for the promotion and will follow all applicable laws.</p>
			  ...
			  <? print $_IDIOMA->traducir("<p>You will not use SOCCERMASH to injure, defame, intimidate, violate the own image or to harass other users.</p>
			  ...
			  <? print $_IDIOMA->traducir("<p>6. IDENTITY THEFT (PROFILE) AND ACCOUNT SECURITY AND REGISTRATION</p>
			  ...
			  <? print $_IDIOMA->traducir("<p>You will not use SOCCERMASH if you are declared guilty of a sex offense.</p>
			  ...
			  <? print $_IDIOMA->traducir("<p>To all these effects, we inform you that SOCCERMASH may give notice and collaborate opportunely with the police and judicial authorities, if we detect identity theft that could involve the commission of a crime.</p>
			  ...
			  <? print $_IDIOMA->traducir("<p>You will not publish anyone's identification documents or any financial information on SOCCERMASH.</p>
        	  ...
        	  <p>SOCCERMASH owns all industrial and intellectual properties rights related to the Service, except for the users contents that will be continue belonging to them according to the following section. You will not use our copyrights or trademarks (including SOCCERMASH, SOCCERMASH.com, visual identity, logos of SOCCERMASH) or any branding derivations, such as the emblematic shield, the visual style of interfaces and photos and news information, like live sports results and derivatives. It is also contemplated in this clause that it will not be using any trademark that looks like ours without our written permission.<br />");?>
			   ...
			   <? print $_IDIOMA->traducir("As the owner of the Service, SOCCERMASH grants a limited, non-sub-licensable and revocable license to use the Service exclusively in a personal way, it is prohibited any emission, change, reproduction, public communication and, at the end, any use and exploitation of the entirely or part of the contents (images, photos, videos, audio, information, icons, indexes, etcetera) that contain the entirely website, as well as the software and database required for the operation, without having our express and prior written authorization.<br />
				...
				<? print $_IDIOMA->traducir("<p>8. USERS PROFILE CONTENTS</p>
			  ...
			  <? print $_IDIOMA->traducir(" This content does not infringe in any applicable laws such as the relating to the right to privacy, to the image and/ or to the honor, intellectual or industrial property rights or similar, or any right of a third party, whether a person or a company.<br />
			  ...
			  <? print $_IDIOMA->traducir("<p>9. INFRINGEMENT NOTICE</p>
        	  ...
        	  <p> Content identification or personal data or protected right which has been violated.<br />
        	    ...
        	    <? print $_IDIOMA->traducir("A signed Statement in which the complainant declares that the previous information is truthful and that claims to be the legitimate holder (or who is authorized to act in his name) of the presumably harmed rights, all this properly credited according to SOCCERMASH.</p>
        	  ...
        	  <p>You are the only one in charge of the interactions you have with other network users. Your personal relations will not be controlled by SOCCERMASH, what we do recommend to you is to choose well your friends, and make sure that their identities are true. If you consider that someone is exceeding the limits of your confidence, do not hesitate to come to us, and we will take appropriate action.<br />
			   ...
			   <? print $_IDIOMA->traducir(" <p>11. ADVERTISING</p>
			  ...
			  <? print $_IDIOMA->traducir("<p>You can get to a specific audience in SOCCERMASH by buying advertisement.<br />
        	    ...
        	    <? print $_IDIOMA->traducir("Your ads will comply with our advertising norms.<br />
        	    ...
        	    We cannot control the way in which people will interact with your ads and we are not responsible for fraudulent clicks or any other improper actions that affect the cost of the active ads. Nevertheless, we do have systems to detect and filter certain suspicious activities.<br /> You can cancel the order at any time through our online portal, but it may take 24 hours until we deactivate the ad. It will be your responsibility to cover the cost of these ads.<br />
        	    Our license to run your ad will end when we have completed your order. You understand, however, that if users have interacted with your ad, this one could remain active until the user eliminates it.<br />"); ?>
			 	...
			 	<? print $_IDIOMA->traducir(" We can use your ads and content and information related to marketing or promotional purposes.<br />
				...
				<? print $_IDIOMA->traducir("If we did not comply with some part of this Statement, no exemption will be considered.<br />
        	  ...
        	  <? print $_IDIOMA->traducir("<p>12. USE OF LINKS</p>
        	  <p>It is strictly forbidden to use any resource without taking care its nature so that someone, user or not form SOCCERMASH, can directly or indirectly benefit, with or non-profit, of the profiles and the own contents of the network.<br />
        	    Nobody will be able to insert in your web, blog, forum, profile of SOCCERMASH or any social network, a link, hyperlink, framing or similar bond that redirect to URLs of contents of SOCCERMASH and/ or SOCCERMASH profiles without any written authorization of the SOCCERMASH team. If some link of these characteristics where detected that could harm the fundamental users rights, you will be completely legitimized to remove that link and, where appropriate, to inform to the competent authorities.</p><p>13. CHANGES</p>"); ?>
			  
        	  
        	   
			   
			   
			   <? print $_IDIOMA->traducir("  <p>SOCCERMASH is entitled to replace, complete and/or modify the Conditions of Use and the Privacy Policy and the Data Protection, due to strategic corporate decisions, technical reasons or by services changes or regulations, as well as modifications that might be derived from applicable codes.<br />
				...
				<? print $_IDIOMA->traducir("<p>14. APPLICABLE LAW AND JURISDICTION</p>
        	  <p>14.1. Conflicts</p>
        	  ...
        	  <p>By SOCCERMASH, we mean the features and services that we provide, including the ones that are offered through (a) our website in WWW.SOCCERMASH.COM and any other website branded or co-branded of SOCCERMASH (including sub-domains, international versions, widgets and mobile versions); (b) our Platform; (c) social plugins and (d) other means, software, existing networks or devices or hereafter developed.<br />
				...
				<? print $_IDIOMA->traducir(" The term &quot;information&quot; refers to the facts and other information about you, including the actions you realize.<br />
				...
				<? print $_IDIOMA->traducir("<p>17. OTHERS</p>
        	  <p>This Statement is an agreement between you and SOCCERMASH CORP.<br />
				...
				<? print $_IDIOMA->traducir("This Statement does not grant any third party beneficiary rights.<br />
        	    By accessing or using SOCCERMASH you will comply with all the applicable laws.</p>
        	  ...
        	  <p>You can be a SOCCERMASH user if you are over 12 years. As older than 12 years you are solely responsible of the age you claim to have.<br />
			   ...
			   <? print $_IDIOMA->traducir("If somebody informs SOCCERMASH that a minor has registered in the Service, we will adopt the needed measures, and we are able to eliminate and block the user's profile.<br />
			  ...
			  ");?>
			   ...
			   <? print $_IDIOMA->traducir("At the moment, and while the procedure does not change, enter the section &quot;My Account&quot;, within in &quot;Settings&quot;, and then, press &quot;Eliminate Account&quot;. It is necessary to know that once realized this step there will not be possible rectification or return back.</p>
        	  <p>21. COOKIES</p>
