...
<span class='icon iposition' id="careerHiddenAg"></span>
			  ...
			  <thead>
			<tr><th width="79"><?php print $_IDIOMA->traducir("Category"); ?></th><th width="78"><?php print $_IDIOMA->traducir("Club"); ?></th><th width="65"><?php print $_IDIOMA->traducir("Matches"); ?></th><th width="65"><?php print $_IDIOMA->traducir("Titular"); ?></th><th width="54"><?php print $_IDIOMA->traducir("Goals Scored"); ?></th><th width="54"><?php print $_IDIOMA->traducir("Assists"); ?></th><th width="63"><?php print $_IDIOMA->traducir("Yellow"); ?> <br /><?php print $_IDIOMA->traducir("Cards"); ?></th><th width="61"><?php print $_IDIOMA->traducir("Red"); ?> <br /><?php print $_IDIOMA->traducir("Cards"); ?></th><th width="37"><?php print $_IDIOMA->traducir("Seasons"); ?></th><th class="whitecell" width="17"></th></tr>
</thead>
<tbody>
<tr>
<td>
...
<?php }else{
echo $_IDIOMA->traducir("You can not edit this profile, only can edit your own profile");
} ?>