...
<td><input class="insert" type="text" onkeypress="LP_data(event);" maxlength="4" id="addYearOfSeasonCareerag">
</td>
...
while ($row = mysql_fetch_array($asd)) {
		...
		echo $row['category']."</a> ".utf8_encode("�");
		echo '</div></td>';
