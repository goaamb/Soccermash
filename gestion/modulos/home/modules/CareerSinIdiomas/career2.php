<div id="career"><h4 id="caree">CAREER<em><input type="button" class="publish" value="PUBLISH" /></em><em class="plus open close"></em></h4>
...
<thead>
<tr><th width="79">Category</th><th width="78">Club</th><th width="65">Matches</th><th width="65">Titular</th><th width="54">Goals</th><th width="54">Goal <br />Passes</th><th width="63">Red <br />Cards</th><th width="61">Yellow <br />Cards</th><th width="37">Seasons</th><th class="whitecell" width="17"></th></tr>
</thead>
<tbody>
<tr>
...
echo '</table><br /><strong>Last Update </strong>'.$date.'<br /><br />';
?>
</div><!--END innerCont..-->
<hr /></div>
