...
<thead>
<tr><th width="100">Title</th><th width="139">Club</th><th width="182">Country</th><th width="38">Year</th><th class="whitecell" width="18"></th></tr>
</thead>
<tbody>
<?
...
<?php 
$sql4="SELECT * FROM $tableProfile WHERE category='National' AND hidden='Visible' AND idPlayer=$iUserIdSM ORDER BY id DESC";
