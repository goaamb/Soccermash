...
if ($exist=='No hay datos = 0'){
	...
	echo "Add a description by clicking here with editable mode enabled";
...
while ($row = mysql_fetch_array($sql2)) {
		...
		echo (($row['description'])==NULL ? 'Add a description by clicking here with editable mode enabled' : $row['description']);
