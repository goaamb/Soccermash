<div id="persDistinctions"><h4 id="dist">PERSONAL DISTINCTIONS<em></em><em class="plus open close"></em></h4>
...
?>
			...
			<thead>
			<tr><th width="517">Distinction</th><th width="42">Year</th><th class="whitecell" width="17"></th></tr>
...
<br /><strong>Last Update </strong><?php echo $date; ?><br /><br />
