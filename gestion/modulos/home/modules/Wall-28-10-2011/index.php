...
<div id="wall">
<div id="writeArea"><textarea rows="auto" class="writeWall" id="wrtMain" title="<?php print $_IDIOMA->traducir("Write a public message on this wall");?>" name="writeWall"><?php print $_IDIOMA->traducir("Write a public message on this wall");?></textarea>
<input type="submit" value="<?php print $_IDIOMA->traducir("PUBLISH");?>" name="#" id="publish"  />
