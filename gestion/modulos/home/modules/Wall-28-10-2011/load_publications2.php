...
while ($rowWall = mysql_fetch_array($wall)) {
	...
	?><div class="writeAnswer" id="writeAnswerDiv_<?php echo $row['id'];?>">
			<div id="writeArea">
			<textarea  title="Write a comment" class="yourAnswer <?php echo "aca el rowid"; ?>" id="wrtSec"  name="writeAnswer_<?php echo $row['id']; ?>">Write a comment and press Enter to publish</textarea>
