...
$("#publications").load("http://soccermash.com/gestion/modulos/home/modules/Wall/load_publications.php");
})
...
<div id="wall">
<div id="writeArea"><textarea rows="auto" class="writeWall" id="wrtMain" title="Write a public message on this wall" name="writeWall">Write a public message on this wall</textarea>
<input type="submit" value="PUBLISH" name="#" id="publish"  />
	<div id="divGifForWall"></div>
</div>
<div id="holdComments">
	<div id="wallBar"><span id="Wall">Wall</span> <!-- <span id="Activities">Activities</span> --></div> 
