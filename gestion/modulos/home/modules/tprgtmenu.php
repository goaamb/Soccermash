  ...
  <span class="divisorMnu" id="divisorMnu3"></span>-->
	...
	var_dump($_IDIOMA->diccionario);
		...
		if($iCantMSj>0){
		  ...
		  echo '<span class="numPrivMsgReceived" id="numPrivMsgReceived" title="'.$_IDIOMA->traducir("Received messages").'"></span>';
	...
	?>
      	...
      	<?php if($iCountInvitation>0) {?>
	      	<span onclick="opMsgF();" id="receivedMsgFollow" class="receivedMsgFollow" original-title="<?php print $_IDIOMA->traducir('Friend notification');?>"></span>
			<span class="numReceivedMsgFollow" id="numReceivedMsgFollow" ><?php  echo $iCountInvitation;?></span>
			
		<?php }else{?>
	
			<span onclick="opMsgF();" id="receivedMsgFollow" class="noneMsgFollow" original-title="<?php print $_IDIOMA->traducir('Friend notification');?>"></span>
