...
<form action="/greader.php" method="post" id="formImagen4"
	...
	<?php
	if ($editar) {
		print "value='$mlgr->miAnunciante'";
	}
	?> />
<div id="div-input-file"><input type="file" id="imagen4-real"
	name="imagen-real" onchange="procesarImagen.call(this.form,4);" />
<div id="div-input-falso"><input type="text" id="imagen4" name="imagen"
	class="selImagen" disabled="disabled" /><a class="bottomSearchAdv"
	href="javascript:;" onclick=""><?php
	print $_IDIOMA->traducir ( "Browse" );
	?></a></div>
</div>
<div id="cargando4" style="display:none;margin-top: -21px;position: relative;margin-left: 406px;"><img src="img/indicator.gif" width="16"/></div>
</form>
<div id="contenidoEditor4" style="margin-left: 15px; margin-top: 10px;"></div>
<div
	style="<?php
	if (! $editar) {
		print "display: none;";
	...
	id="prosImage24"><span class="example"><?php
	print $_IDIOMA->traducir ( "Final Image" );
	?></span> <img src="<?php
	if ($editar) {
		print "/goaamb/images/publi/thumb/" . $mlgr->miAnunciante;
	}
	?>" id="imagenFinal4"
	style="<?php
	if (! $editar) {
	...
	onclick="editarImagen.call(this,4,this.getAttribute('rel'));" rel="<?php
	if ($editar) {
		print $mlgr->miAnunciante;
	}
	?>" /></div>
<div
	style="display: none; float: left; margin-top: 27px; margin-left: 40px;"
	id="prosImage34"><span class="example" style="width: auto;"></span> <input
	id="buton1" onclick="guardarImagen('4');" type="button"
...
<div id="preview"
	style="width: 60px; height: 25px; overflow: hidden; border: 1px solid black; float: left; margin-top: 22px; margin-left: 0px;">
<span class="example"
...
<form style="clear: both;float: right;" action="/greader.php" method="post" id="formRevisarAnuncio"
	target="iframeFakeAdvertisement" enctype="multipart/form-data"><input
	type="hidden" name="__q" value="proceso/anuncio" /> <input
	type="hidden" name="__a" value="guardarMiAnunciante" /> <input type="hidden"
	name="imagen4"
	value="<?php
	if ($editar) {
		print $mlgr->miAnunciante;
...
<a style="text-transform: inherit;width: 125px;padding: 2px 5px 0;" class="bottomSearchAdv"
	href="javascript:;" onclick="revisarMySponsor();"><?php
	print $_IDIOMA->traducir ( "Save Sponsor" );
	?></a>
