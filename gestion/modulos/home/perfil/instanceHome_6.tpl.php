...
<?php }?></span>
            <table id="profFields"  width="589" border="0">
            	<tr>
              	...
              	<ul><input type="hidden" value="m" name="agmjc">
				...
				<?php if($editingProfile){ ?>
				 ...
				 <select disabled name="cityag"  class="editmode f11" id="cityag" onChange="selectedCity();" style="float: right; width: 425px;"></select> </li>
				 ...
				 selectCity();
                  ...
                  <?php } ?>
				<?php if($editingProfile){ ?>
				  <li><span><?php print $_IDIOMA->traducir("Club/s"); ?>:&nbsp;</span>
...
<?php }else{ ?>
				...
				<?php } ?>
                  <!-- <li><span>Passport:</span><input class="editmode f6" value="<?php //echo $sPassaport;?>" type="text" /><?php //echo ($editingProfile)? '<img src="img/check_edit_reposo.png" title="Save" onClick="javascript:save(\'f6\');">' : '' ;?> </li> -->
                  <?php // if($editingProfile){ ?>
