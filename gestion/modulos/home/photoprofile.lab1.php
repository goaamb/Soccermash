...
<div id="photoProfile">
 ...
 if(!isset($_SESSION['idUserVisiting']) || $_SESSION['idUserVisiting']==0 || $_SESSION['idUserVisiting']==$_SESSION['iSMuIdKey']){
	...
	<div id="divUpload" class="divUpload" for="inpUpload" onmouseover="mostrar()" ><!--div for change photo-->
...
<div id="underPhoto">
    ...
    <div id="footPhotoprofile" >
          ...
          <li class="txtColorLC"><?php echo $aUsuario['name'].' '.$aUsuario['lastName'];?></li>
        </ul>
    </div>
</div><!--txtRight-->
