...
////////////////////////////////////////////////////////////////////////////////////////
	...
	#Para q el agent pueda admin multimedia del player
...
<!-- ////////////////////// VIDEO UPLOADER ////////////////////////////// -->
						<div id="videoUploader" style="background:#FFF;"> 
							...
							<?
							if((!isset($_SESSION['idUserVisiting']) || $_SESSION['idUserVisiting']==0 || $_SESSION['idUserVisiting']==$_SESSION['iSMuIdKey']) or
							  ( isset($_SESSION["bEditPlayer"]) && ($_SESSION["bEditPlayer"]==true) && ($_SESSION["sNameAgent"]!=false) ) ){
							 #Se añade la comparacion de Agent-Player 	
							?>
...
<!-- ////////////////////// PHOTO UPLOADER ////////////////////////////// -->
						<div id="photoUploader"> 
							...
							<?
							if( (!isset($_SESSION['idUserVisiting']) || $_SESSION['idUserVisiting']==0 || $_SESSION['idUserVisiting']==$_SESSION['iSMuIdKey'])
							or (isset($_SESSION["bEditPlayer"]) && ($_SESSION["bEditPlayer"]==true) && ($_SESSION["sNameAgent"]!=false) ) ){
							 #Se añade la comparacion de Agent-Player 	
							?>
