...
<?     
		...
		foreach($registros as $registro){
			...
			if($editProf==true && $videoOwner==$_SESSION["iSMuIdKey"]){
				...
				$del='<div class="posDelComment"><a href="javascript:;" onclick="delCommentPhoto(pCpv'.$n.'); $(\'#com'.$registro->id.'\').hide();"><div title="'.$_IDIOMA->traducir("Delete").'" class="delMulti" id="delComment"></div></a></div>';
			}
