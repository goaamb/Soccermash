...
?>				
			...
			*/
			...
			?>
					...
					<div><a style="color:#000000;" href="javascript:;" onclick="loadCommentPhoto(pUpvNpN)"><? print $_IDIOMA->traducir('COMMENTS'); ?></a> <span id="cantComment"><? echo $registros[0]->comment;?></span><span id="videoFoot"><!--/ VOTES--> <? //echo $registros[0]->vote;?> / <? print $_IDIOMA->traducir('VIEWS'); ?> <? echo $registros[0]->visit;?></span></div>
