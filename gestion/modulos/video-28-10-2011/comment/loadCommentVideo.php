...
<?
	...
	require_once($_SERVER['DOCUMENT_ROOT'].$dir.'/gestion/modulos/video/comment/videoCommentClass.php');
		...
		////////////leave your comment/////////////
		echo'
		<div style="margin-top:15px; margin-bottom:10px;">'.$_IDIOMA->traducir("Leave your comment").':</div> 
		...
		<?
		 echo '
			...
			<div style="margin-right:8px; margin-top:8px;"><a href="javascript:;" onclick="beforeComment();">'.$_IDIOMA->traducir("Send").'</a></div>
