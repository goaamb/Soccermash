...
class VideoView {
	...
	////////////////SELECT - SELECTS data////////////////
	function selectVideoView($fields,$whereSel,$orderSel='id desc'){
				
		//$tableProfile=$this->selectTable($profileId);
		$tableProfile='ax_videoView';
		
		$registros=$this->selVidView($fields,$tableProfile,$whereSel,$orderSel);	
		return $registros;
...
///////////////SELECT the register/////////////////////////////
		...
		private function selVidView($fields,$tableProfile,$whereSel,$orderSel){
...
////////////////ADD - Check where to insert the data////////////////
	function addVideoView($fields){
				
		//$tableProfile=$this->selectTable($profileId);
		$tableProfile='ax_videoView';
		if($this->addVidView($tableProfile,$fields)){
			return true;
		}else{
			return false;
		}
...
///////////////Inserts the register into de tabl/////////////////////////////
		...
		function addVidView($tableProfile,$fields){
...
////////////////UPDATE - Check where to insert the data////////////////
	function upVideoView($fields,$whereUp){
				
		//$tableProfile=$this->selectTable($profileId);
		$tableProfile='ax_videoView';
		
		if($this->upVidView($tableProfile,$fields,$whereUp)){
			return true;
		}else{
			return false;
		}
...
///////////////UPDATE the register/////////////////////////////
	...
	private	function upVidView($tableProfile,$fields,$whereUp){
...
////////////////Delete - Check where to insert the data////////////////
	function delVideoView($whereDel){
			
			//$tableProfile=$this->selectTable($profileId);
			$tableProfile='ax_videoView';
			
		if($this->delVidView($tableProfile,$whereDel)){
			return true;
		}else{
			return false;
		}
...
///////////////Delete the register/////////////////////////////
		...
		function delVidView($tableProfile,$whereDel){
