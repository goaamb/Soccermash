...
class VideoVote {
	...
	////////////////SELECT - SELECTS data////////////////
	function selectVideoVote($fields,$whereSel,$orderSel='id desc'){
				
		//$tableProfile=$this->selectTable($profileId);
		$tableProfile='ax_videoVote';
		
		$registros=$this->selVidVote($fields,$tableProfile,$whereSel,$orderSel);	
		return $registros;
...
///////////////SELECT the register/////////////////////////////
		...
		private function selVidVote($fields,$tableProfile,$whereSel,$orderSel){
...
////////////////ADD - Check where to insert the data////////////////
	function addVideoVote($fields){
				
		//$tableProfile=$this->selectTable($profileId);
		$tableProfile='ax_videoVote';
		if($this->addVidVote($tableProfile,$fields)){
			return true;
		}else{
			return false;
		}
...
///////////////Inserts the register into de tabl/////////////////////////////
		...
		function addVidVote($tableProfile,$fields){
...
////////////////UPDATE - Check where to insert the data////////////////
	function upVideoVote($fields,$whereUp){
				
		//$tableProfile=$this->selectTable($profileId);
		$tableProfile='ax_videoVote';
		
		if($this->upVidVote($tableProfile,$fields,$whereUp)){
			return true;
		}else{
			return false;
		}
...
///////////////UPDATE the register/////////////////////////////
	...
	private	function upVidVote($tableProfile,$fields,$whereUp){
...
////////////////Delete - Check where to insert the data////////////////
	function delVideoVote($whereDel){
			
			//$tableProfile=$this->selectTable($profileId);
			$tableProfile='ax_videoVote';
			
		if($this->delVidVote($tableProfile,$whereDel)){
			return true;
		}else{
			return false;
		}
...
///////////////Delete the register/////////////////////////////
		...
		function delVidVote($tableProfile,$whereDel){
