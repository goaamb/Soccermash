...
?>				
				...
				<div id="votesHolder">
					...
					<!-- /////////Stars from Votes///////////// -->
					<div id="voteTitle"><? print $_IDIOMA->traducir('VOTE'); ?></div>
			...
			?>
					...
					<div><a style="color:#000000;" href="javascript:;" onclick="loadComment(iUpvNpN)"><? print $_IDIOMA->traducir('COMMENTS'); ?></a> <span id="cantComment"><? echo $registros[0]->comment;?></span><span id="videoFoot">/ <? print $_IDIOMA->traducir('VOTES'); ?> <? echo $registros[0]->vote;?> / <? print $_IDIOMA->traducir('VIEWS'); ?> <? echo $registros[0]->visit;?></span></div>
