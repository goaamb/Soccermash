	...
	if($registros[0]!=''){
		...
		foreach($registros as $registro){
			...
			/////////check if its editable///////////
				...
				$delVid= '<div class="posDelMulti"><a href="javascript:;" onclick="setTheIndicator(this); delVideo(iVpuF_ph'.$i.');"><div title="'.$_IDIOMA->traducir("Delete").'" id="delMulti" class="delMulti"></div></a></div>';
