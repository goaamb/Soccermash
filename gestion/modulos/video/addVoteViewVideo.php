<?
	...
	/////////Update video Votes or Views///////////////////////
		...
		$vidUp=new Video();
		$registros=$vidUp->selectVideo(addslashes(base64_decode($vFv[1])),'visit,vote,voteValue','id="'.addslashes(base64_decode($vFv[1])).'"',"id desc");
		#votes
		$where='idVideo="'.addslashes(base64_decode($vFv[1])).'"';
		...
		#update votes
		$fields['vote']=$totalVote+1;
		$fields['voteValue']=($registros[0]->voteValue*$totalVote + addslashes(base64_decode($vFv[8])))/($totalVote+1);
