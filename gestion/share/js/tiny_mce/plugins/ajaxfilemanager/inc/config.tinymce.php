...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', SERVER_URL.'/content/images/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', SERVER_URL.'/content/images/');	//accept relative path only
	...
	define('CONFIG_UPLOAD_MAXSIZE', 5 * 1024 * 1024 ); //by bytes
