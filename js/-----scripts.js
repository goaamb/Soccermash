...
$('#visibleArea ul li a').click(function(){																	 
										...
										$('#srchInst, #srchMult').hide();
										$('#searchStep1').html($('#stepOne').html());
										$('#searchStep2').html($('#stepTwo').html());
										break;
										
										case '2':
										$('#searchStep2, #searchStep1').empty();
										$('#advSearcher, #srchMult').hide();
										$('#searchStep2').html($('#srchInst').html());
										break;
										
										case '3':
										$('#searchStep2, #searchStep1').empty();
										$('#advSearcher, #srchInst').hide();
										$('#searchStep2').html($('#srchMult').html());
										break;
										}
...
$('.openabout').click(function(){
										...
										$('body').scrollTop(0);
										var nowHeight = $('body').height();
										$('#help').height(nowHeight).load('gestion/modulos/home/about.php').fadeIn();
										return false;
});
$('.openlegal').click(function(){
										...
										$('body').scrollTop(0);
										var nowHeight = $('body').height();
										$('#help').height(nowHeight).load('gestion/modulos/home/legal.php').fadeIn();
										return false;
});
