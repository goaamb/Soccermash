...
$('input[type="text"]').keypress(function(e)
					...
					if (code === 13){
							switch(presentInput){
									...
									break;
									case 'signUpBttn':
										JS_enviarRegistrar(); return false;
									break;
									case 'strgToSearch':
										JS_search(); return false;
									break;
									default:
									break;
								}
...
$('#slideInner').css('width', slideWidth * numberOfSlides ); //slideWidth * numberOfSlides
...
$("#foundationDate").datepicker({changeMonth: true, changeYear: true}).datepicker("option", "yearRange", '1800:2100');
