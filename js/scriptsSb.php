...
function saveVideoFile(){
			...
			if($("#nameVideo").val()==''){
						$("#nameAdvisorVideo").html('<? print $_IDIOMA->traducir('* please, complete the video name'); ?>');
				}else{
						$("#nameAdvisorVideo").html('');
				}
				
			if($("#tagsVideo").val()==''){
						$("#tagsAdvisorVideo").html('<? print $_IDIOMA->traducir('* please, complete the video tags with words separated by commas'); ?>');
				}else{
						$("#tagsAdvisorVideo").html('');
				}	
				
			if($("#youtube").val()=='' && $("#fileName").val()==''){
						$("#fileAdvisorVideo").html('<? print $_IDIOMA->traducir('* please, complete your video'); ?>');
						fileN='';
				}else{
			...
			if($("#nameVideo").val()!='' && fileN!='' && $("#tagsVideo").val()!=''){
				...
				$("#saveVideoFile").html('<img src="img/indicator.gif" width="16" height="16"/> <? print $_IDIOMA->traducir("uploading, please wait..."); ?>');
...
function savePhotoFile(){
			...
			if($("#namePhoto").val()==''){
						$("#nameAdvisorPhoto").html('<? print $_IDIOMA->traducir('* please, complete the Photo name'); ?>');
				}else{
						$("#nameAdvisorPhoto").html('');
				}
				
			/*if($("#tagsPhoto").val()==''){
						$("#tagsAdvisorPhoto").html('<? print $_IDIOMA->traducir('* please, complete the Photo tags with words separated by commas'); ?>');
				}else{
						$("#tagsAdvisorPhoto").html('');
				}*/	
				
			if($("#photoFileName").val()==''){
						$("#fileAdvisorPhoto").html('<? print $_IDIOMA->traducir('* please, complete your Photo'); ?>');
			...
			if($("#namePhoto").val()!='' && $("#photoFileName").val()!='' /*&& $("#tagsPhoto").val()!=''*/){
				...
				$("#savePhotoFile").html('<img src="img/indicator.gif" width="16" height="16"/> <? print $_IDIOMA->traducir("uploading, please wait..."); ?>');
...
function chkSrch(){
		...
		//////set player filtgers visible//////////
		if($('#storeSelectADVProfile').val()=='1'){
				$('#seePlayer').show();
		}
		
		
	
		//////////Reset all checkboxes filters/////////
		/*$("#puc").removeAttr('checked');
		$("#pwc").removeAttr('checked');
		$("#amtp").removeAttr('checked');
		$("#xpy").removeAttr('checked');
		///////health////
		$("#nutrs").removeAttr('checked');
		$("#sptmedics").removeAttr('checked');
		$("#mssgts").removeAttr('checked');*/
}


/////////Hide seePlayer for button close (court)/////////////
	/*function hideSeePlayer(){
		$('#seePlayer').hide();
			
			$("#pucpuc").removeClass('lblCHK2');
			$("#puc").attr('checked','');
			
			$("#pwcpwc").removeClass('lblCHK2');
			$("#pwc").attr('checked','');
			
			$("#amtpamtp").removeClass('lblCHK2');
			$("#amtp").attr('checked','');
			
			$("#xpyxpy").removeClass('lblCHK2');
			$("#xpy").attr('checked','');
	...
	function hideSeeHealth(){
			alert($("#nutrs").attr('checked'));
			//$('#seeHealth').hide();
			$("#nutra").removeClass('lblCHK2');
			$("#nutrs").attr('checked','');
			$("#sptmedica").removeClass('lblCHK2');
			$("#sptmedics").attr('checked','');
			$("#mssgta").removeClass('lblCHK2');
			$("#mssgts").attr('checked','');
			$("#countrySearch2").val('');
	}*/
...
////////check the live-results to see if there is a goal//////////
	var tTheResults='empty';
	var tTheDivToCheck='';
	var tNewLiveResults=new Array();
	var t='';
	var TscoreDiv='';
	var pleaseCheckIt='no';
	var uUrlTosave='';
